...
public class _4_FindMedianSortedArrays {
    public static double findMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        ArrayList<Integer> integers = new ArrayList<>(nums1.length + nums2.length);
        ...
        while (i1 < nums1.length || i2 < nums2.length) {
            ...
            Integer n2 = null;
            if (integers.size() > 0) {
                n3 = integers.get(integers.size() - 1);
            }
            ...
            if (i1 < nums1.length && i2 < nums2.length) {
                ...
                if (n1.compareTo(n2) == 0) {
                    if (null != n3 && n1.compareTo(n3) == 0) {
                        integers.add(n1);//去重不加此行
                        integers.add(n1);//去重不加此行
                        i1++;
                        i2++;
                    } else {
                    ...
                    if (null != n3 && n2.compareTo(n3) == 0) {
                        integers.add(n2);//去重不加此行
                        i2++;
                    } else {
                        integers.add(n2);
                        i2++;
        ...
        if (1 == size) {
            ...
            int i3 = integers.size() / 2;
            int i = integers.size() % 2;
            if (i == 0) {
                r = (integers.get(i3) + integers.get(i3 - 1)) / (double) 2;
            } else {
                r = integers.get(i3);
            }
        }
    ...
    public static double findMedianSortedArrays2(int[] nums1, int[] nums2) {
        ...
        int i4 = (nums1.length + nums2.length) / 2 + 1;

        ArrayList<Integer> integers = new ArrayList<>(i4);

        int i1 = 0, i2 = 0;
        while (integers.size() < i4) {
            Integer n1 = null;
            Integer n2 = null;
        ...
        if (1 == size) {
            ...
            int i3 = i % 2;
            if (i3 == 0) {
                r = (integers.get(size - 2) + integers.get(size - 1)) / (double) 2;
            } else {
                r = integers.get(size - 1);
            }
        }
    ...
    public static void main(String[] args) {
        // int[] nums1 = new int[]{0, 1, 5, 6, 7, 11, 12};
        // int[] nums2 = new int[]{0, 1, 2, 3, 4, 5, 11, 18};
